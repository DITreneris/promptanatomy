...
- **Operatoriaus tier 9/12:** [docs/user-access-tier-registry.md](docs/user-access-tier-registry.md) §3. Po 9→12 grant – **naujas** magic link (`access_tier=12`); LP 12/12 nereiškia, kad senas `/anatomy/` sesija atrakino M10.
