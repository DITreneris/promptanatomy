...
**Data fiksavimo:** 2026-05-24 (Hero badge kategorija; Navbar Variant B; Hero subtitle + 3 bullets). **Atnaujinta 2026-06-05:** LP copy chirurgija; proof skaičiai — **500+** biblioteka (hero bullet, WhatIs stat, pricing features), **600+** social proof (`hero.socialProof`). **Atnaujinta 2026-08-07:** refund trust → `/terms#refunds`; `#access` return path; **600+** palikta. **Atnaujinta 2026-08-08:** Six-Block/Quick mode — tik GEO (`llms` / `TRAINING_SUMMARY`), ne WhatIs/FAQ (frontpage lean).
