 ...
 * Loads only when VITE_X_PIXEL_ID is set. Deferred to idle — not on the critical path.
 * X ads are not commercially active at the moment; config remains for future re-enable.
 */
