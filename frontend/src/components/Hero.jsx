          ...
          <div className="relative bg-brand-dark rounded-[40px] p-10 border border-white/10 shadow-soft-lg overflow-hidden font-mono">
            ...
            <div className="space-y-8">
              <div className="group/line cursor-default transition-all hover:translate-x-1">
                <div className="text-[10px] text-slate-600 mb-2 font-black tracking-[0.2em]">{t('hero.codeLine1')}</div>
              ...
              <div className="group/line cursor-default transition-all hover:translate-x-1">
                <div className="text-[10px] text-slate-600 mb-2 font-black tracking-[0.2em]">{t('hero.codeLine2')}</div>
              ...
              <div className="group/line cursor-default transition-all hover:translate-x-1">
                <div className="text-[10px] text-slate-600 mb-2 font-black tracking-[0.2em]">{t('hero.codeLine3')}</div>
