...
export default function Methodology() {
  ...
  return (
    <section id="metodologija" className="py-20 md:py-28 mt-20 bg-linear-to-b from-slate-50 to-slate-100/80 px-4 sm:px-6 md:px-8 border-y border-slate-100 overflow-hidden">
      <div className="max-w-7xl mx-auto min-w-0">
        <div className="flex flex-col lg:flex-row justify-between items-end mb-16 md:mb-24 gap-12">
          <div className="max-w-2xl">
            ...
            <h3 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter leading-none bg-linear-to-r from-brand-dark to-slate-700 bg-clip-text text-transparent">
